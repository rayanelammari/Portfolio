...
function articles_events()
{
	...
	function add_project(project, inverted, featured)
	{
		...
		if (featured)
		{
			...
			{
				document.querySelector('#articles_section .articles_content').innerHTML += `
		...
		else
		{
			...
			document.querySelector('#articles_section .other_articles_content').innerHTML += `
	...
	function generate(data)
	{
		...
		for (let project of data.articles)
		{
			let featured;
		...
		elements = document.querySelectorAll('#articles_section .in_animation');
	...
	{
		read_json("resources/jsons/articles.json", generate);
	}
	...
	document.querySelectorAll('#articles_section .sort_choices .choice').forEach((el) =>
	{
